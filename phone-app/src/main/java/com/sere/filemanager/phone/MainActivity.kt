...
fun PhoneFileManagerApp() {
    ...
    FileManagerTheme {
        when (screen.value) {
            ...
            PhoneScreen.RemoteSettings -> RemoteSettingsScreen(state.remoteSettings, viewModel::toggleUploads, viewModel::toggleDelete, viewModel::toggleSettingsAdvanced, viewModel::toggleSettingsHidden, viewModel::syncSettingsToWatch) { screen.value = PhoneScreen.Home }
