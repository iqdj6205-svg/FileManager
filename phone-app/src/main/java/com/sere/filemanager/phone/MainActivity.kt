...
fun PhoneFileManagerApp() {
    ...
    FileManagerTheme {
        when (screen.value) {
            ...
            PhoneScreen.WatchCompanion -> WatchCompanionScreen(state.remoteUrl, state.statusMessage, viewModel::setRemoteUrl, viewModel::startPairing, viewModel::startRemoteServer, viewModel::stopRemoteServer, viewModel::requestWatchStatus, viewModel::refreshRemoteSnapshot, viewModel::sendFiles) { screen.value = PhoneScreen.Home }
